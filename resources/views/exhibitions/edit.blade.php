...
@section('content')
                ...
                <div class="card-body">
                    <form action="{{ route('exhibitions.update', $exhibition->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @enderror>
                                    <div class="form-text text-muted">
                                        Текущая дата: <strong>{{ $exhibition->start_date->format('d.m.Y') }}</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @enderror>
                                    <div class="form-text text-muted">
                                        Текущая дата: <strong>{{ $exhibition->end_date->format('d.m.Y') }}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror>
                            <div class="form-text text-muted">
                                Текущее место: <strong>{{ $exhibition->location }}</strong>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header bg-light">
                    <h6 class="mb-0"><i class="fas fa-info-circle"></i> Информация о выставке</h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <strong><i class="fas fa-heading"></i> Название:</strong><br>
                        <span class="text-primary">{{ $exhibition->title }}</span>
                    </div>

                    <div class="mb-3">
                        <strong><i class="fas fa-map-marker-alt"></i> Место:</strong><br>
                    ...
                    <div class="mb-2">
                        <small class="text-muted">
                            <i class="fas fa-calendar-plus"></i> Создана:
                    ...
                    <div class="mb-2">
                        <small class="text-muted">
                            <i class="fas fa-calendar-check"></i> Обновлена:
                            {{ $exhibition->updated_at->format('d.m.Y H:i') }}
                        </small>
                    </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('tickets.create') }}?exhibition_id={{ $exhibition->id }}" class="btn btn-outline-success btn-sm">
                            <i class="fas fa-plus"></i> Создать билет
                        </a>
                        <a href="{{ route('exhibitions.index') }}" class="btn btn-outline-secondary btn-sm">
                            <i class="fas fa-list"></i> Все выставки
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Валидация дат при отправке формы
